...
\multirow{4}{*}{1.7B} & FP16 (no quant)$^\dagger$ & 49.0\% & 16.0 & 1.010 & 1.00$\times$ \\
 ...
 & \textbf{Ours (Binary ctrl.)}$^\star$ & \textbf{TBD} & \textbf{5.86}$^\S$ & \textbf{0.415}$^\S$ & \textbf{2.43}$\times$$^\S$ \\
\bottomrule
\end{tabular}
\label{tab:main}
\end{table}
