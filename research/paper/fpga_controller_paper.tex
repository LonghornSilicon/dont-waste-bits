...
\multirow{4}{*}{1.7B} & FP16 (no quant)$^\dagger$ & 49.0\% & 16.0 & 1.010 & 1.00$\times$ \\
 ...
 & \textbf{Ours (Binary ctrl.)}$^\star$ & \textbf{TBD} & \textbf{5.03}$^\S$ & \textbf{0.357}$^\S$ & \textbf{2.84}$\times$$^\S$ \\
\bottomrule
\end{tabular}
\label{tab:main}
\end{table}
...
\textbf{1.65} & \textbf{72.0\%} & \textbf{28.0\%} & \textbf{5.12} & \textbf{2.76}$\times$ & \textbf{Good operating point} \\
1.70 & 75.7\% & 24.3\% & 5.03 & 2.84$\times$ & Matches DWB avg\_bits \\
