...
Across all five checkpoints (scales 124M--1.7B, three model families: SmolLM/LLaMA, OPT/Meta, GPT/OpenAI), the formula error is $\leq\pm 0.083$. The formula is hardware-derived ($0.267 = (c_8{-}c_4)/C_\text{FP16}$) and architecture-independent: it adapts to any model's KV statistics via a single CPU calibration pass on 1--10 texts ($<3$ seconds).
