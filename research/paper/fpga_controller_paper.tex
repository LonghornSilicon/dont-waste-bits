...
\caption{Left: FPGA throughput speedup over FP16. Our binary controller matches static INT4 (3.48$\times$) and outperforms paper DWB (2.44$\times$) by $+$43\%. Right: accuracy vs. FPGA cost. Our method and static INT4 dominate the Pareto frontier at 360M; DWB spends more BRAM for no accuracy gain.}
